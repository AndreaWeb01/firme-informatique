...
@section("contenu")
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Modifier Utilisateur</h4>
                </div>
                <div class="col-lg-6">
                        ...
                        <form action="{{ route('users.update', $user->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="firstname" class="form-control @error('firstname') is-invalid @enderror" id="firstname" value="{{ $user->prenom }}" required>
                                    @error('firstname')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
